...
if __name__ == '__main__':
    ...
    lte_linelist = "theo_3900_4000_lines"
    output_file = "nlte_theo_3900_4000_lines"

    
    nlte_models = ["../COM/DATA/ATOMS/Ca/atom.ca105b"]

    #nlte_models = ["../COM/DATA/ATOMS/Mg/atom.mg86b"]
    ...
    transition_names = [["Ca I","Ca II"]]  # needs to match the length of nlte_models and needs to match the transition names in the lte linelist
    #transition_names = [["Mg I","Mg II"]]
...
#                                                             "Ca II"]]  # needs to match the length of nlte_models and needs to match the transition names in the lte linelist
    ...
    ion_energy = [[0.0, 6.11316]]  # ionization energy in eV from NIST
    #ion_energy = [[0.0, 7.646235]]  # ionization energy in eV from NIST
